          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] text-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-pink-500/25 border border-white/10 text-sm font-medium"
